    ...
    <div class="card rounded">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-center mt-5 mb-5 ">
          <img class="wd-md-400 wd-300" src="{{ (!empty ($item->photo_barang)) ? url('/barang_image/' .$item->photo_barang) :url('no_image.jpg')}}" alt="photo_barang">
        </div>
        <div class="d-flex justify-content-center gap-6 mb-5">
          ...
          <div>
            ...
            <p class="text-muted">{{ $item->tanggal_masuk }}</p>
            </div>
            <div class="mt-3">
              <label class="tx-13 fw-bolder mb-0 text-uppercase">Quantity:</label>
              <p class="text-muted">{{ $item->barang->jumlah_barang }}</p>
            </div>
            <div class="mt-3">
          ...
          <div>
            ...
            <div class="mt-3">
              ...
              <p class="text-muted">{{ $item->resi_pengiriman }}</p>
            </div>
            <div class="mt-3">
              <label class="tx-13 fw-bolder mb-0 text-uppercase">Pengirim:</label>
              <p class="text-muted">{{ $item->pengirim }}</p>
            </div>
          </div>   
          <div>
            <div class="mt-3">
